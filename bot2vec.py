...
def main():
    osn_input_file = 'F:/luan van/bot2vec-master/data/inputs/karate-club/karate.edgelist.txt'
    emb_output_file = 'F:/luan van/bot2vec-master/data/outputs/karate-club/karate-club.emb'
